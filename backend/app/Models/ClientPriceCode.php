...
class ClientPriceCode extends Model
{
    ...
    /**
     * The client this price code belongs to.
     */
    ...
    /**
     * Scope to filter by client and service type.
     */
    public function scopeForClientAndServiceType(Builder $query, int $clientId, int $serviceTypeId): Builder
    {
